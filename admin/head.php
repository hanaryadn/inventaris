...
<nav class="navbar navbar-default">
    ...
    <ul class="nav navbar-nav">
        ...
        <li><a href="../halaman/tentang.php"><i class="glyphicon glyphicon-info-sign"></i> Tentang</a></li>
        <li><a href="../halaman/kritik_saran.php"><i class="glyphicon glyphicon-envelope"></i> Kritik & Saran</a></li> -->
    <?php
        session_start();
         ...
         <div class="btn pull-right">
                Masuk sebagai : <a href="#" class="btn btn-default btn-sm">            
                <?php echo "$_SESSION[nama] ($_SESSION[jabatan])"; ?></a> 
